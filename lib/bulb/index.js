...
class Bulb extends Device {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              on_off = _ref2.on_off;
              return _context2.abrupt('return', on_off === 1);
  ...
  setPowerState(value, sendOptions) {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3() {
      var _ref3, _ref3$dft_on_state, dft_on_state;
      ...
      return _regenerator2.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this3.lighting.getLightState(sendOptions);

            case 2:
              _ref3 = _context3.sent;
              _ref3$dft_on_state = _ref3.dft_on_state;
              dft_on_state = _ref3$dft_on_state === undefined ? {} : _ref3$dft_on_state;
              return _context3.abrupt('return', _this3.lighting.setLightState((0, _assign2.default)(dft_on_state, { on_off: value ? 1 : 0 }), sendOptions));
  ...
  togglePowerState(sendOptions) {
    ...
    return (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4() {
      var _ref4, _ref4$dft_on_state, dft_on_state, on_off;
      ...
      return _regenerator2.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _this4.lighting.getLightState(sendOptions);

            case 2:
              _ref4 = _context4.sent;
              _ref4$dft_on_state = _ref4.dft_on_state;
              dft_on_state = _ref4$dft_on_state === undefined ? {} : _ref4$dft_on_state;
              on_off = _ref4.on_off;
              _context4.next = 8;
              return _this4.lighting.setLightState((0, _assign2.default)(dft_on_state, { on_off: !on_off ? 1 : 0 }), sendOptions);

            case 8:
              return _context4.abrupt('return', !on_off);
